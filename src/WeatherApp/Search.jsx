...
function Search({ updateInfo }) {
  ...
  return (
    <div className="text-center mt-5 mx-auto" style={{"width":"50rem"}}>
      <div className="row">
        <h1 className="fw-bold">WeatherX</h1>
        <h4>Enter a city name to get current weather conditions</h4>
        <div className="mt-5 d-flex justify-content-center gap-3 " >
          <input
            className="form-control p-4 fs-5 h-75"
            type="text"
          ...
          />
          <button
            className="btn btn-primary fs-5 fw-bold h-75"
